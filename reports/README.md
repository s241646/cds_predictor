...
The largest cost to the team was the Compute Engine, followed by Vertex AI, due to the training jobs that were ran there. There was also some costs to the Artifact Registry and Cloud Run, where the API is hosted. Cloud storage has a suprisingly low usage costs. The costs are shared for the team for the whole project.
